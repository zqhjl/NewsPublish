      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
        <li class="layui-nav-item layui-nav-itemed">
          ...
          <dl class="layui-nav-child">
            <dd>
		<a href="${pageContext.request.contextPath}/news/toNewsList" data-id="1" data-title="图书列表" data-url="${pageContext.request.contextPath}/news/toNewsList"
       	  class="site-demo-active" data-type="tabAdd">新闻列表</a>
			</dd>
            <dd>
		<a href="${pageContext.request.contextPath}/news/toPublish" data-id="2" data-title="添加图书" data-url="${pageContext.request.contextPath}/news/toPublish"
